			...
			<div class="delete-info-content p-4">
				...
				<div style="text-align: right">
					...
					<div class="btn-box" style="text-align: right">
						<a type="button" class="theme-btn button-success border-0" href="../owner/update_camp.wcc">수정</a>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-body" align='center'>
									<a href="../search/camp_detail.wcc?camp_idx="
								...
								<div class="modal-footer">
									<form method="post" action="../owner/delete_camp.wcc">

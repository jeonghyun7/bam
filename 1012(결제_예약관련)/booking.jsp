                        ...
                        <div class="margin-left-option">
                           ...
                           <div class="btn-box mt-4">
                                ...
                                <button disabled="" id="bt_pay" class="tt theme-btn border-0" onclick="requestPay()" type="submit"
                                		style="background-color:#bfbbbb; border-color:#bfbbbb; margin-left:20px; margin-bottom:10px; padding:3px 300px;cursor:pointer"><span id="camp_total" class="camp_total"></span>원 결제하기
                                </button>

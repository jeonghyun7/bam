...
//		String fromEmail = "[발송보낼 이메일]";
		...
		//회원가입 메일 내용
		if(div.equals("join")) {
			subject = "불밤야밤 Hompage 회원가입 인증 메일입니다!";
			msg += "<div align='center' style='border:1px solid black; font-family:verdana'>";
			msg += "<h3 style='color: blue;'>";
			msg += member.getEmail() + "님 회원가입을 환영합니다.</h3>";
			msg += "<div style='font-size: 130%'>";
			msg += "하단의 인증 버튼 클릭 시 정상적으로 회원가입이 완료됩니다.</div><br/>";
			msg += "<form method='post' action='http://localhost:8080/sign_up/approval_member.bam'>";
//			msg += "<form method='post' action='https://3.35.93.88:8443/sign_up/approval_member.bam'>";

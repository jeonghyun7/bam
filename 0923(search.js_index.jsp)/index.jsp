                        ...
                        <div class="card-content-wrap">
                            <div class="card-content">
                                <a href="camp/camp_detail.bam?camp_idx=${unit.camp_idx}">
                                    <h5 class="card-meta" style="color: white";><span class="la la-home"></span> 캠핑장</h5>
                                ...
                                <ul class="info-list padding-top-20px" style="color: white";>
                        ...
                        <c:if test="${unit.halfStarExist}">
                           ...
                           <span class="la la-star last-star"></span>
                                ...
                                <div class="listing-info">
                                    <ul>
                                        <li style="color: white";><span class="la la-eye info__count" ></span> 247</li>
                                    </ul>
                                </div>
                            </div>
...
<script> //페이지 로드시 자동으로 아래 스크립트문들을 통하여 기본날짜가 표시되어있습니다.

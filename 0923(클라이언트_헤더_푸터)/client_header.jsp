	...
	<div class="side-user-panel">
        ...
        <div class="side-menu-wrap side-user-menu-wrap">
            ...
            <ul class="side-menu-ul">
            	<c:if test="${member != null}">
                <li><a style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/member/mypage.bam?selected=info'"><span class="la la-user user-icon"></span> 회원정보</a></li>
                ...
                <li><a style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/owner/com_inquiry.bam'"><span class="la la-plus-circle user-icon"></span> 업체 문의</a></li>
                </c:if>

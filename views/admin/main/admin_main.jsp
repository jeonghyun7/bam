									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">						
										<div class="card mb-3">
											<div class="card-header">
												...
												어제와 오늘의 매출액 비교 <span style="font-size:13px; font-weight:bold;">매출 통계<a target="_blank" href="sales_camp_monthly.wcc">&lt;자세히 보기&gt;</a></span>
											</div>
									...
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">						
										<div class="card mb-3">
											<div class="card-header">
												...
												<span style="font-size:13px; font-weight:bold;">회원 관리<a target="_blank" href="member_manage.wcc">&lt;자세히 보기&gt;</a></span><br/>
												<span style="font-size:13px; font-weight:bold;">탈퇴 회원 관리<a style="font-size:5px" target="_blank" href="leave_member_manage.wcc">&lt;자세히 보기&gt;</a></span>
											</div>

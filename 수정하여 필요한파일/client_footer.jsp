            ...
            <div class="col-lg-3 column-td-6">
                <div class="footer-item">
                    ...
                    <ul class="info-list contact-links">
                        <li><span class="la la-home"></span> 대전광역시 서구 1160 10층</li>
                        <li><span class="la la-headphones"></span> <a href="#">+ 81 042 777 7777</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copy-right margin-top-50px padding-top-60px">
                    <p class="copy__desc">
                        &copy; Copyright WeCamp 2022. Made with
                        <span class="la la-heart-o"></span> by <a href="https://github.com/Binveloper">DL</a>, <a href="https://github.com/OnceDeveloper">SJ</a>, <a href="https://github.com/cateto">HS</a>, <a href="https://github.com/dlalstj0213">JH </a>
                    </p>
                    <ul class="list-items">

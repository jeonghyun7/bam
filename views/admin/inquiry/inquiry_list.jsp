...
<nav aria-label="...">
  <ul class="pagination justify-content-center">
 	<c:choose>
 		...
 		<c:otherwise>
			<li class="page-item">
		      <a class="page-link" onclick="getInquiryList(${page.startPage-1});">Previous</a>
		    </li>
 		</c:otherwise>
 	</c:choose>
 	...
 	<c:choose>
 		...
 		<c:otherwise>
 		    <li class="page-item">
		      <a class="page-link" onclick="getInquiryList(${page.endPage+1});">Next</a>
		    </li>
 		</c:otherwise>
 	</c:choose>
  </ul>
